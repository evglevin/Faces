...
class PersonDetailTableViewController: UITableViewController, CNContactViewControllerDelegate {
    ...
    */
    ...
    func showPhoneAlert() {
        ...
        let call = UIAlertAction(title: "Call".localized, style: .default, handler: { _ in
            self.person?.phone?.makeAColl()
        })
        let createContact = UIAlertAction(title: "Add contact".localized, style: .default, handler: { _ in
